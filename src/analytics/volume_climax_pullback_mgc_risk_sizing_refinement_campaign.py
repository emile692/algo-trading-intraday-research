"""Local refinement campaign around the best MGC risk-sizing zone."""
...
CONFIG = SymbolRefinementConfig(
    symbol="MGC",
    output_prefix="volume_climax_pullback_mgc_risk_sizing_refinement_",
    risk_pcts=(0.0075, 0.0080, 0.0085, 0.0090, 0.0095, 0.0100, 0.0105),
    max_contracts_grid=(2, 3, 4, 5, 6),
    best_previous_winner_name="risk_pct_0p0100__max_contracts_3__skip_trade_if_too_small_true",
    best_previous_winner_risk_pct=0.0100,
