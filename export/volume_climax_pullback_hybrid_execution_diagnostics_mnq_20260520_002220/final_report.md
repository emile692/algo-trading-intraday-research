...
- Recalibration does not recover positive ex-post PnL convincingly without changing the alpha.
...
| entry_price_effect | -3283.4500 |
| stop_before_target_effect | 0.0000 |
| target_not_reached_effect | -3423.7250 |
...
- Reconstructed paths: `0`.
- First touch = stop: `0`.
- First touch = target: `0`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0.7500 | 0.7500 | 275 | 0.0000 | 0.0000 |  | inf |  | 120.0000 | Ex-post 1min replay with fixed alpha and stop-first ambiguity convention. |

## 11. Verdict
- `Likely execution artifact: baseline 1H/1H should not be trusted.`
