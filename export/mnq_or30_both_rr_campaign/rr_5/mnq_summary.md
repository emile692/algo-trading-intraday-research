...
- OOS score=0.785, PF=1.292, Sharpe=1.226, Return/DD=1.805

## Final Recommendations

- Best OOS ensemble: `majority_50` (score=0.785, PF=1.292, Sharpe=1.226, MaxDD=-13939.00).
- Most robust ensemble: `majority_50` (robustness=-0.801).
- Baseline-like ensemble retained if solid: `majority_50`.
- Best point cell: `ATR 28 / q27/q94` (score=1.133).
- Most robust point cell: `ATR 25 / q25/q94` (local robustness=0.215).

## Robust Clusters

- Cluster 1: 45 cells, ATR 25-30, Qlow 25-30, Qhigh 93-95, avg score=0.887.
- Cluster 2: 1 cells, ATR 25-25, Qlow 30-30, Qhigh 94-94, avg score=1.023.
